...
For TanStack AI, use the [native skill source](integrations/tanstack-ai/README.md), [integration guide](apps/docs/content/docs/integrations/tanstack-ai.mdx), and [Next.js chat demo](examples/tanstack-ai/README.md).
