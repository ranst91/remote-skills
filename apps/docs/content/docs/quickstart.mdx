...
Using Vercel AI SDK? Follow the [integration guide](/docs/vercel-ai-sdk) to connect its skill loader. The example below uses a small interface you can adapt to other agents.
