...
Using an agent framework? Choose an [integration guide](/docs/integrations) to connect your agent's skill tools. The example below uses a small interface you can adapt to other agents.
