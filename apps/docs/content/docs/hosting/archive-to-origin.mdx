...
A successful build prints no output. Check `dist/.well-known/agent-skills/index.json` for your skills and the generated `artifacts/` directory for their files.
