...
Using Vercel AI SDK or Mastra? The [framework integrations](/docs/integrations) connect these operations to your agent's skill tools, so it can discover and load skills without writing your own tools.
