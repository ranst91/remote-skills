...
Using an agent framework? The [framework integrations](/docs/integrations) connect these operations to your agent's skill tools, so it can discover and load skills without writing your own tools.
